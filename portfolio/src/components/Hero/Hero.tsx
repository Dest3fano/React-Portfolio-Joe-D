      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="space-y-6">
            <h1 className="text-3xl font-bold leading-tight text-[#edf6ff] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl animate-slideUp">
              Hey, I'm{' '}
          ...
          {/* CTA Buttons */}
          <div className="flex flex-wrap gap-4 animate-slideUp" style={{ animationDelay: '0.4s' }}>
            <a
              href="#projects"
        ...
        {/* Right column - Image */}
        <div className="relative lg:ml-auto animate-fadeIn" style={{ animationDelay: '0.2s' }}>

export const aboutData = {
  ...
  stats: [
    ...
    { label: "Projects Completed", value: "10+", icon: "FaBriefcase" },
    { label: "Technologies", value: "15+", icon: "FaCode" },
    { label: "Coffee Consumed", value: "∞", icon: "FaCoffee" }
  ],

  interests: [
    { label: 'Building side projects', icon: 'FaRocket' },
    { label: 'Learning new technologies', icon: 'FaBookOpen' },
    { label: 'UI/UX design', icon: 'FaPalette' },
    { label: 'Open source contribution', icon: 'FaHandsHelping' },
    { label: 'Coffee brewing', icon: 'FaCoffee' },
    { label: 'Cybersecurity', icon: 'FaShieldAlt' },
    { label: 'Hacking', icon: 'FaLaptopCode' }
  ]
};
